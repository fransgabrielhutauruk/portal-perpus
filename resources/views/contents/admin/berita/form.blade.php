...
<div id="kt_app_content_container" class="app-container container-fluid" data-cue="slideInLeft" data-duration="1000"
    data-delay="0">
    <form id="formData" action="{{ $pageData->dataBerita['id'] ? route('app.berita.update') : route('app.berita.store') }}" class="needs-validation" jf-form="berita">
        <div class="row" data-cue="slideInLeft" data-duration="1000" data-delay="0">
            <div class="col-md-8">
                <x-card>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <x-form.select class="mb-2" label="Status" name="status_berita" value=""
                        ...
                        <div class="col-md-6">
                            <x-form.input class="mb-2" type="datetime-local" label="Tanggal Berita"
                                name="tanggal_berita"
