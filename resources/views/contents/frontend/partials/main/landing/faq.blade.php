<section class="our-service bg-section faq-section">
    <div class="container">
            ...
            <div class="col-12">
                <div class="section-title text-center mb-5">
                    <h3 class="wow fadeInUp">
                        {{ data_get($faqData, 'content.subtitle') }}
                    </h3>
                    <h2 class="wow fadeInUp" data-wow-delay="0.25s">
                        {!! data_get($faqData, 'content.title') !!}
                    </h2>
                    <p class="wow fadeInUp" data-wow-delay="0.5s">
                        {!! data_get($faqData, 'content.description') !!}
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                @forelse (data_get($faqData, 'faqs', []) as $index => $faq)
                    <div class="faq-item wow fadeInUp" data-wow-delay="{{ 0.1 * ($index + 1) }}s">
                ...
                @if (count(data_get($faqData, 'faqs', [])) > 0)
                    <div class="text-center mt-5 wow fadeInUp" data-wow-delay="0.75s">
                        <a href="{{ data_get($faqData, 'action.url') }}" class="btn-default">
                            {{ data_get($faqData, 'action.text') }}
                        </a>
                    </div>
                @endif
            </div>
