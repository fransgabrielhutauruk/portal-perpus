                        ...
                        <div class="tab-content mt-5" id="usulanTabsContent">
                            ...
                            <div class="tab-pane fade mt-3" id="tab-book" role="tabpanel">
                                ...
                                <div class="row mt-md-4">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="fw-bold text-muted small text-uppercase d-block mb-2">Bahasa
                                ...
                                <div class="row mt-md-4">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label" for="penerbit_salemba">Salemba</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input penerbit-checkbox" type="checkbox"
                                                    name="penerbit[]" id="penerbit_informatika" value="Informatika">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input penerbit-checkbox" type="checkbox"
                                                    name="penerbit[]" id="penerbit_elsevier" value="E-Book Elsevier">
                                            ...
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label" for="penerbit_pearson">Pearson</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="penerbit_other"
                                                    onchange="togglePenerbitOther()">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="fw-bold text-muted small text-uppercase d-block mb-2">Jenis
                                                Buku <span class="text-danger">*</span></label>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input jenis-buku-checkbox" type="checkbox"
                                                    name="jenis_buku[]" id="jenis_referensi"
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input jenis-buku-checkbox" type="checkbox"
                                                    name="jenis_buku[]" id="jenis_hobi" value="hobi">
