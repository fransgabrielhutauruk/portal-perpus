                                    ...
                                    @forelse(data_get($content, 'history', []) as $item)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if ($item->praktikum)
                                                    <span class="badge bg-secondary text-light ms-2">Praktikum</span>
                                                @else
                                                    <span
                                                        class="badge bg-secondary text-light border ms-2">Teori</span>
                                                @endif
                                            </td>
...
<script>
    ...
    function addHistoryRow(data) {
        ...
        const jenisBadge = data.praktikum == 1 ?
            '<span class="badge bg-secondary text-light ms-2">Praktikum</span>' :
            '<span class="badge bg-secondary text-light border ms-2">Teori</span>';
